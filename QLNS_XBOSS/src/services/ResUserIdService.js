...
export default class ResUserIdService extends Servies {
  modelName() {
    return 'hr.employee';
  }

  getUserId(domain = [], fields = [], offset, limit, orderBy, url, method) {
    return new Promise((resolve, rejects) => {
      ...
      this.post(params, url)
        .then((resService) => {
          console.log('kt resService tại res user id', resService);
